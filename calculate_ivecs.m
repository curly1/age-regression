...
%% Train data
train_database = load([cd '/data/database_WithAgeMFCC60D.mat']);
...
if cv == 0
K = 1;
test_database = load([cd '/data/database_WithAgeMFCC60D.mat']);
...
%% Train/load ubm
if load_ubm == 1, for_ubm = load([cd '/data/ubm1024_T400_YT_agender_german_ubm_MFCC60D.mat']); ubm = for_ubm.ubm; T = for_ubm.T;
